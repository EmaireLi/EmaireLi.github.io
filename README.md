...
首页的首屏、“站内路标”和精选阅读用于帮助第一次到访的人进入不同内容。

维护原则：

- 首屏简短说明“技术学习、项目实践和日常写作”的主题，不罗列岗位方向。
- 站内路标固定指向精选阅读、项目记录和时间线归档。
- 精选阅读按内容主题组织，不按招聘者、技术评审者等访客角色组织。
- 新增更有代表性的文章后，优先替换精选入口，而不是无限增加卡片。

## 维护“关于本站”

首页“关于本站”只简要说明本地写作、旧笔记同步、归档搜索和静态发布方式。

维护原则：

- 保持简短，不把首页变成代码仓库说明书。
- 具体命令、脚本和部署细节继续放在 README。
- 如果文章导入、清单生成、搜索或部署流程变化，先更新 README，再同步首页概述。
- 不新增付费服务或外部账号依赖。
